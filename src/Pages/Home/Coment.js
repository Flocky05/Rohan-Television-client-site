      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="relative md:col-span-2 lg:col-span-2">
          <img
            ...
            src="https://img.freepik.com/free-photo/millennial-asia-businessmen-businesswomen-meeting-brainstorming-ideas-about-new-paperwork-project-colleagues-working-together-planning-success-strategy-enjoy-teamwork-small-modern-night-office_7861-2386.jpg?w=1060&t=st=1671520288~exp=1671520888~hmac=4d61fe6d4d11150c531ea1e18859a8451047f3089b5862e21f29a19e6e703d07"
            alt=""
          />
        </div>
      </div>
